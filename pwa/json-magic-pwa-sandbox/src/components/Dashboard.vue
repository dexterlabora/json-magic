      ...
      <pane min-size="5" size="25">
        <v-card width="100%">
          <v-toolbar dense>
            ...
            <v-spacer></v-spacer>
            <v-btn small @click="download('query.txt',form.query)" color="green" tile outlined dark>
              <v-icon small>mdi-arrow-down-bold</v-icon>Query
            </v-btn>
            <v-btn small @click="download('result.json',result)" color="green" tile outlined dark>
              <v-icon small>mdi-arrow-down-bold</v-icon>JSON
            </v-btn>
          </v-toolbar>
          ...
          <v-card-actions>
            <div style="width:100%">
               <vue-prism-editor v-model="form.query" language="js" class="pl-2" ></vue-prism-editor>
            </div>
        ...
        <v-card v-if="result" width="100%">
          <v-toolbar dense>
            ...
            <v-btn small @click="onExportCsv" color="green" tile outlined dark>
              <v-icon small>mdi-arrow-down-bold</v-icon>CSV
            </v-btn>
            <v-btn small @click="onDownloadTable" color="green" tile outlined dark>
              <v-icon small>mdi-arrow-down-bold</v-icon>HTML Table
            </v-btn>
          </v-toolbar>
          <v-card-text>
...
export default {
  ...
  computed: {
    tableHtml() {
      ...
      return `${tableify(this.result).replace(
        "<table>",
  ...
  methods: {
    onApiData(data){
      console.log('dash api data', dataString)
